...
export class RegistrarSolucionComponent implements OnInit {
  ...
  createFormGroup(){
    return new FormGroup({
      ...
      tiempo: new FormControl('',[Validators.required,Validators.min(1)]),
      intento: new FormControl('',[Validators.required,Validators.min(1)]),
  ...
  error_tiempo() {
    ...
    if(this.tiempo.hasError('minLength'))
  ...
  error_intento() {
    ...
    if(this.intento.hasError('minLength'))
      return 'Ingrese minimo 3 caracteres';
